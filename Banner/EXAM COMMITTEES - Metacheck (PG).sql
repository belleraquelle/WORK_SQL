...
FROM
    ...
    LEFT JOIN shrdgmr ON a1.sorlcur_pidm = shrdgmr_pidm AND a1.sorlcur_key_seqno = shrdgmr_stsp_key_sequence
...
WHERE
    ...
    AND NOT (c1.shrapsp_astd_code_end_of_term IS NULL AND c1.shrapsp_prev_code IS NULL AND b1.szrcmnt_comment IS NULL AND shrdgmr_degs_code IS NULL)
