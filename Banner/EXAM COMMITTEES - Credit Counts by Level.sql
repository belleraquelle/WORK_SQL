...
scbcrse,
spriden
where shrtckn.shrtckn_pidm IN
    (SELECT glbextr_key FROM glbextr WHERE glbextr_selection = '202001_PINK' AND glbextr_user_id = 'BANSECR_SCLARKE')
and spriden_pidm = shrtckn_Pidm
and spriden_change_ind is null
and shrtckn.shrtckn_stsp_key_sequence = 1
...
HAVING SUM(shrtckg.shrtckg_credit_hours) >= 90
;
