/*
 * This report gives a list of all of the status PN and status AW awards against students in the specified popsel who have a 'current' Exceptional
...
FROM
	...
	JOIN shrmrks ON a1.spriden_pidm = shrmrks_pidm
