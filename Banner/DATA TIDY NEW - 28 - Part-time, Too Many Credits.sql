...
WHERE
    ...
    -- Pick out 'current' sorlcur records for current AY
    ...
    AND s1.sfrstcr_pidm NOT IN (
        ...
        WHERE s2.sfrstcr_rsts_code IN ('RE','RW','RC') AND z1.ssbsect_subj_code = 'EXCH' AND ssbsect_term_code IN ('202109','202201')
    )
