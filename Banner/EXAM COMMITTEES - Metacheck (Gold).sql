...
METACHECK! Outputs a host of Exam Committee related data for all students in the Gold pages for final checking.
...
FROM
	sorlcur t1
	LEFT JOIN shrapsp ON shrapsp_stsp_key_sequence = t1.sorlcur_key_seqno AND shrapsp_pidm = sorlcur_pidm AND shrapsp_term_code = '201909' AND shrapsp_activity_date >= '01-JAN-2020'
