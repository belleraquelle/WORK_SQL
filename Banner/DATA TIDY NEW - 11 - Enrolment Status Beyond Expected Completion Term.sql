...
SELECT
	...
	sfrensp_term_code AS "Enrolment_Term",
...
WHERE 
	...
	-- Identify records where there is an EL status recorded against the study path in a term beyond the student's expected completion term
